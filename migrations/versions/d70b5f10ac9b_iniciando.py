...
Revision ID: d70b5f10ac9b
Revises: 
Create Date: 2022-02-14 13:00:24.371675
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('aprovador', 'complainer', 'admin', name='roletype'), server_default='complainer', nullable=False),
